<template>
  <div class="relative inline-block text-left">
    ...
    <transition name="fade">
      <div v-if="dropdownOpen" class="origin-top-right absolute right-0 mt-2 text-black  border border-gray-300 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
